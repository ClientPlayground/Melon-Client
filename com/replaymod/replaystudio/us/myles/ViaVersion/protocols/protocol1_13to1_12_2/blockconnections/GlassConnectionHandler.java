...
public class GlassConnectionHandler extends AbstractFenceConnectionHandler {
  ...
  protected byte getStates(UserConnection user, Position position, int blockState) {
    ...
    return (states == 0 && ((ProtocolInfo)user
      .get(ProtocolInfo.class)).getServerProtocolVersion() <= 47 && ((ProtocolInfo)user
      .get(ProtocolInfo.class)).getServerProtocolVersion() != -1) ? 15 : states;
  }
}
