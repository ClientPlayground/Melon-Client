package com.replaymod.replaystudio.us.myles.ViaVersion.protocols.protocol1_15to1_14_4.storage;
...
public class EntityTracker extends StoredObject implements ExternalJoinGameListener {
  ...
  public void onExternalJoinGame(int playerEntityId) {
    this.clientEntityTypes.put(Integer.valueOf(playerEntityId), Entity1_15Types.EntityType.PLAYER);
  }
}
