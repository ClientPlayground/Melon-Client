...
public class ProtocolVersion {
  ...
  public static void register(@NonNull ProtocolVersion protocol) {
    ...
    versions.put(Integer.valueOf(protocol.getId()), protocol);
    versionList.add(protocol);
  }
  
  public static boolean isRegistered(int id) {
    return versions.containsKey(Integer.valueOf(id));
  }
  
  public static ProtocolVersion getProtocol(int id) {
    ProtocolVersion protocolVersion = versions.get(Integer.valueOf(id));
  ...
  public String toString() {
    return String.format("%s(%d)", new Object[] { getName(), Integer.valueOf(getId()) });
  }
}
