  ...
  class Button extends GuiButton {
    ...
    protected void mouseDragged(Minecraft mc, int mouseX, int mouseY) {
      if (this.visible) {
        ...
        GuiUtils.drawRoundedOutline(this.xPosition, this.yPosition, this.xPosition + (int)(this.field_146156_o * (this.width - 8)) + 8, this.yPosition + this.height, 2.0F, 2.0F, (new Color(205, 205, 205, 100)).getRGB());
        GuiUtils.drawRoundedRect(this.xPosition, this.yPosition, this.xPosition + (int)(this.field_146156_o * (this.width - 8)) + 8, this.yPosition + this.height, 2.0F, (new Color(255, 255, 255, 50)).getRGB());
        GuiUtils.drawRoundedRect(this.xPosition + (int)(this.field_146156_o * (this.width - 8)), this.yPosition, this.xPosition + (int)(this.field_146156_o * (this.width - 8)) + 8, this.yPosition + this.height, 2.0F, (new Color(255, 255, 255, 100))
            .getRGB());
      } 
    }
