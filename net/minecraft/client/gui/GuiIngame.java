...
import me.kaimson.melonclient.ingames.utils.Crosshair;
...
public class GuiIngame extends Gui {
  ...
  public void renderGameOverlay(float partialTicks) {
    ...
    EventHandler.call((Event)new TickEvent.RenderTick.Overlay(TickEvent.Phase.START, partialTicks));
    ...
    GlStateManager.enableBlend();
    if (showCrosshair() && this.mc.gameSettings.thirdPersonView == 0)
      if (!IngameDisplay.CUSTOM_CROSSHAIR.isEnabled()) {
        GlStateManager.tryBlendFuncSeparate(775, 769, 1, 0);
        GlStateManager.enableAlpha();
        drawTexturedModalRect(i / 2 - 7, j / 2 - 7, 0, 0, 16, 16);
      } else {
        Crosshair.INSTANCE.render(IngameDisplay.CUSTOM_CROSSHAIR, scaledresolution);
      }  
    GlStateManager.enableAlpha();
    GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
    ...
    if (scoreobjective1 != null && !IngameDisplay.SCOREBOARD.isEnabled())
    ...
    EventHandler.call((Event)new TickEvent.RenderTick.Overlay(TickEvent.Phase.END, partialTicks));
    GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
