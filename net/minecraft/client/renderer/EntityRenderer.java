...
public class EntityRenderer implements IResourceManagerReloadListener {
  ...
  private void hurtCameraEffect(float partialTicks) {
    if (this.mc.getRenderViewEntity() instanceof EntityLivingBase && !(this.mc.getRenderViewEntity() instanceof me.kaimson.melonclient.ingames.utils.ReplayMod.viewer.camera.CameraEntity)) {
  ...
  private void orientCamera(float partialTicks) {
    ...
    if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping()) {
      ...
      if (!this.mc.gameSettings.debugCamEnable) {
        ...
        if (Perspective.isToggled()) {
          GlStateManager.rotate(Perspective.cameraYaw + 180.0F, 0.0F, -1.0F, 0.0F);
          GlStateManager.rotate(Perspective.cameraPitch, -1.0F, 0.0F, 0.0F);
        } else {
    ...
    if (!this.mc.gameSettings.debugCamEnable) {
      ...
      if (Perspective.isToggled()) {
        f6 = Perspective.cameraYaw + 180.0F;
        f7 = Perspective.cameraPitch;
      } 
      float f8 = 0.0F;
      ...
      EventHandler.call((Event)(event = new EntityViewRenderEvent.CameraSetup(this.roll)));
      f8 = event.roll;
  ...
  public void renderHand(float p_renderHand_1_, int p_renderHand_2_, boolean p_renderHand_3_, boolean p_renderHand_4_, boolean p_renderHand_5_) {
    ...
    if (IngameDisplay.OLD_ANIMATIONS.isEnabled() && 
      IngameDisplay.OLD_ANIMATIONS_BUILD.isEnabled()) {
      if (this.mc.thePlayer.getItemInUseCount() != 0 && this.mc.gameSettings.keyBindAttack.isKeyDown() && this.mc.gameSettings.keyBindUseItem.isKeyDown() && this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit.equals(MovingObjectPosition.MovingObjectType.BLOCK)) {
        ...
        if (stack != null && stack.getItem() != null && (
          !this.mc.thePlayer.isSwingInProgress || this.mc.thePlayer.swingProgressInt >= getArmSwingAnimationEnd((EntityLivingBase)this.mc.thePlayer) / 2 || this.mc.thePlayer.swingProgressInt < 0)) {
  ...
  private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
    ...
    EventHandler.call((Event)new RenderWorldLastEvent());
