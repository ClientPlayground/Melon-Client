...
public class Minecraft implements IThreadListener, IPlayerUsage {
      ...
      while (this.running) {
        if (!this.hasCrashed || this.crashReporter == null) {
          try {
            ...
            if (!IngameDisplay.FASTER_WORLD_LOADING.isEnabled())
              System.gc(); 
          } 
          continue;
        } 
  ...
  private void startGame() throws LWJGLException, IOException {
    ...
    Client.instance.registerKeybinds();
    ...
    AchievementList.openInventory.setStatStringFormatter(new IStatStringFormat() {
          public String formatString(String str) {
            try {
              return String.format(str, new Object[] { GameSettings.getKeyDisplayString(this.this$0.gameSettings.keyBindInventory.getKeyCode()) });
  ...
  private void createDisplay() throws LWJGLException {
    ...
    Display.setTitle("Minecraft 1.8.9 - Melon Client");
    try {
  ...
  public void displayGuiScreen(GuiScreen guiScreenIn) {
    ...
    EventHandler.call((Event)new GuiScreenEvent.Open((GuiScreen)guiGameOver));
    ...
    if (guiGameOver != null) {
      ...
      EventHandler.call((Event)new GuiScreenEvent.Close());
  ...
  private void runGameLoop() throws IOException {
    ...
    if (!this.skipRenderWorld) {
      EventHandler.call((Event)new TickEvent.RenderTick(TickEvent.Phase.START, this.timer.renderPartialTicks));
      this.mcProfiler.endStartSection("gameRenderer");
      this.entityRenderer.updateCameraAndRender(this.timer.renderPartialTicks, i);
      this.mcProfiler.endSection();
      EventHandler.call((Event)new TickEvent.RenderTick(TickEvent.Phase.END, this.timer.renderPartialTicks));
    } 
    this.mcProfiler.endSection();
  ...
  public void runTick() throws IOException {
    ...
    EventHandler.call((Event)new TickEvent.ClientTick(TickEvent.Phase.START));
    ...
    EventHandler.call((Event)new TickEvent.ClientTick(TickEvent.Phase.END));
    this.mcProfiler.endSection();
