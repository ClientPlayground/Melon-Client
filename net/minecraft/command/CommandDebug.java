...
public class CommandDebug extends CommandBase {
  ...
  private String getProfileResults(long timeSpan, int tickSpan) {
    ...
    stringbuilder.append("// This is approximately ").append(String.format("%.2f", new Object[] { Float.valueOf(tickSpan / (float)timeSpan / 1000.0F) })).append(" ticks per second. It should be ").append(20).append(" ticks per second\n\n");
