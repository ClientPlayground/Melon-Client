...
public class CommandClearInventory extends CommandBase {
  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException {
    ...
    if (k == 0)
      throw new CommandException("commands.clear.failure", new Object[] { entityplayermp.getCommandSenderName() }); 
    if (j == 0) {
      sender.addChatMessage((IChatComponent)new ChatComponentTranslation("commands.clear.testing", new Object[] { entityplayermp.getCommandSenderName(), Integer.valueOf(k) }));
    } else {
