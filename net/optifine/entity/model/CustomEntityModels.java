...
public class CustomEntityModels {
  ...
  public static void update() {
    ...
    if (map == null) {
      ...
      map.clear();
      map1.clear();
      map.putAll((Map)originalEntityRenderMap);
      map1.putAll((Map)originalTileEntityRenderMap);
  ...
  private static Map<Class, Render> getEntityRenderMap() {
    ...
    if (originalEntityRenderMap == null)
      originalEntityRenderMap = (Map)new HashMap<>(map); 
    return map;
  }
  ...
  private static Map<Class, TileEntitySpecialRenderer> getTileEntityRenderMap() {
    ...
    if (originalTileEntityRenderMap == null)
      originalTileEntityRenderMap = (Map)new HashMap<>(map); 
    return map;
  }
