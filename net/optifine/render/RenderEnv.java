...
public class RenderEnv {
  ...
  public boolean isBreakingAnimation(List listQuads) {
    if (this.breakingAnimation == -1 && listQuads.size() > 0)
      if (listQuads.get(0) instanceof net.minecraft.client.renderer.block.model.BreakingFour) {
        this.breakingAnimation = 1;
      } else {
  ...
  public boolean isBreakingAnimation(BakedQuad quad) {
    if (this.breakingAnimation < 0)
      if (quad instanceof net.minecraft.client.renderer.block.model.BreakingFour) {
        this.breakingAnimation = 1;
      } else {
        this.breakingAnimation = 0;
      }  
  ...
  public boolean isSmartLeaves() {
    if (this.smartLeaves == -1)
      if (Config.isTreesSmart() && this.blockState.getBlock() instanceof net.minecraft.block.BlockLeaves) {
        this.smartLeaves = 1;
      } else {
        this.smartLeaves = 0;
      }  
