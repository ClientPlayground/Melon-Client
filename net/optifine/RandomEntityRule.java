  ...
  public boolean matches(IRandomEntity randomEntity) {
    ...
    if (this.collarColors != null && randomEntity instanceof RandomEntity) {
      ...
      if (entity1 instanceof EntityWolf) {
        ...
        if (!Config.equalsOne(enumdyecolor, (Object[])this.collarColors))
          return false; 
      } 
    } 
    ...
    if (this.moonPhases != null) {
      ...
      if (worldClient != null) {
        int j1 = worldClient.getMoonPhase();
    ...
    if (this.dayTimes != null) {
      WorldClient worldClient = (Config.getMinecraft()).theWorld;
      if (worldClient != null) {
        int k1 = (int)worldClient.getWorldInfo().getWorldTime();
    ...
    if (this.weatherList != null) {
      WorldClient worldClient = (Config.getMinecraft()).theWorld;
      if (worldClient != null) {
        Weather weather = Weather.getWeather((World)worldClient, 0.0F);
