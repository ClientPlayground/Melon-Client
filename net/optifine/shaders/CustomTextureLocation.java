...
public class CustomTextureLocation implements ICustomTexture {
  ...
  public ITextureObject getTexture() {
    if (this.texture == null) {
      ...
      if (this.texture == null) {
        this.texture = (ITextureObject)new SimpleTexture(this.location);
  ...
  public String toString() {
    return "textureUnit: " + this.textureUnit + ", location: " + this.location + ", glTextureId: " + ((this.texture != null) ? (String)Integer.valueOf(this.texture.getGlTextureId()) : "");
  }
}
