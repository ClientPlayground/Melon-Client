...
public class CapeUtils {
  ...
  public static void downloadCape(AbstractClientPlayer player) {
    ...
    if (s != null && !s.isEmpty() && !s.contains("\000") && PATTERN_USERNAME.matcher(s).matches()) {
      ...
      ThreadDownloadImageData threaddownloadimagedata1 = new ThreadDownloadImageData((File)null, s1, (ResourceLocation)null, (IImageBuffer)capeimagebuffer);
