...
public class ConnectedParser {
  ...
  public static Comparable parseValue(String str, Class<String> cls) {
    return (cls == String.class) ? str : ((cls == Boolean.class) ? Boolean.valueOf(str) : Double.valueOf((cls == Float.class) ? Float.valueOf(str).floatValue() : ((cls == Double.class) ? Double.valueOf(str).doubleValue() : ((cls == Integer.class) ? Integer.valueOf(str).intValue() : ((cls == Long.class) ? Long.valueOf(str) : null).longValue()))));
  }
